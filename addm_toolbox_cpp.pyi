...
class aDDM(DDM):
    ...
    @classmethod
    def fitModelMLE(cls, trials: List[aDDMTrial], rangeD: List[float], rangeSigma: List[float], rangeTheta: List[float], rangeK: List[float] = ..., computeMethod: str = ..., normalizePosteriors: bool = ..., barrier: float = ..., nonDecisionTime: int = ..., bias: List[float] = ..., decay: List[float] = ...) -> MLEinfoaDDM: ...
