...
class aDDM(DDM):
    ...
    def computeParallelNLL(self, trials: List[aDDMTrial], timeStep: int = ..., approxStateStep: float = ...) -> ProbabilityData: ...
    def exportTrial(self, adt: aDDMTrial, filename: str) -> None: ...
    @classmethod
    def fitModelMLE(cls, trials: List[aDDMTrial], rangeD: List[float], rangeSigma: List[float], rangeTheta: List[float], rangeK: List[float] = ..., computeMethod: str = ..., normalizePosteriors: bool = ..., barrier: float = ..., nonDecisionTime: int = ..., timeStep: int = ..., approxStateStep: float = ..., bias: List[float] = ..., decay: List[float] = ...) -> MLEinfoaDDM: ...
